...
HD_PWD='/ad/eng/users/r/y/ryanbs/Desktop/EC413_Lab4/EC413_Lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FA_64bit_RCA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FA_64bit_RCA.tcl
