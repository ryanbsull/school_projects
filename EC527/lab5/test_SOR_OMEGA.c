...
#define START_OMEGA 1.75 /* The first OMEGA value to try */
#define OMEGA_INC 0.001  /* OMEGA increment for each O_ITERS */
#define O_ITERS 250      /* How many OMEGA values to test */
